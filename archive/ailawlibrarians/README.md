# AI Law Librarians backup (Rebecca Fordon's posts)
...
- `image_urls.txt` — tab-separated post slug and original image URL.

Post body content sits inside `<div class="entry-content">` in each HTML file.
